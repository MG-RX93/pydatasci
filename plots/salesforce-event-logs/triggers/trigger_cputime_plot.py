...
# CPU Data Set
all_cpu_time_values = full_df['CPU_TIME'].values

# Mean of full data frame
mean = round(np.mean(all_cpu_time_values),2)
print("\nMean of CPU TIME:")
print(mean)

# Std Dev of full data frame
std_dev = round(np.std(all_cpu_time_values),2)
...
print("\nSAMPLED DATA - Mean of CPU TIME:")
print(mean)
std_dev = round(np.std(cpu_time_values),2)
print("\nSAMPLED DATA - Standard Deviation of CPU TIME:")
print(std_dev)
...
plt.hist(df['CPU_TIME'], bins=15, alpha=0.7)  
