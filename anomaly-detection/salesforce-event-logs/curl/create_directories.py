...
def create_directory_structure(base_dir, financial_year, quarter, sprint_name, event_types):
    ...
    for original_event_type, directory_name in event_types.items():
        ...
        full_dir_path = os.path.join(base_dir, financial_year, quarter, sprint_name, directory_name)
...
create_directory_structure(base_directory, financial_year, quarter, sprint_name, event_types_mapping)
